  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomSheet: CurvedSheet(
        ...
        firstGradiantColor: widget.firstGradiantColor ?? Colors.black,
        secondGradiantColor: widget.secondGradiantColor ?? Colors.indigo,
        backText: widget.backText ??'',
        skipText: widget.skipText ??'',
        forwardColor: widget.forwardColor ?? Colors.black,
        forwardIconColor: widget.forwardIconColor ?? Colors.indigo,
        textColor: widget.textColor ?? Colors.black,
        backgroundColor: widget.backgroundColor ?? Colors.white,
        bottomSheetColor: widget.bottomSheetColor ?? Colors.indigo,
        skip: () {
